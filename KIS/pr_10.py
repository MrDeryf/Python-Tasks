...
x = [
    [" 737-81-62", "mail.ru", "А. Шолук", "00.10.19"],
...
print(
    main(
        [
            [None, "Родли Д.Ш.:нет", None, "0.6", "rodli82@gmail.com"],
            [None, "Филерянц Г.Л.:нет", None, "0.4", "fileranz58@mail.ru"],
            [None, "Сишич В.С.:да", None, "0.1", "sisic59@mail.ru"],
        ]
    )
)
