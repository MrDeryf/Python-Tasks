...
@deal.reason(TypeError, lambda x1, x2, y1, y2: (isinstance(x1, (float)) == False and isinstance(y1, (float)) == False and isinstance(x2, (
float)) == False and isinstance(y2, (float)) == False))
